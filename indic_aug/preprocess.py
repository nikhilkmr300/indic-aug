...
class Preprocess:
    ...
    def _batch_process(self, src_batch, tgt_batch, funcs, batch_num):
        """Preprocesses corpus file in batches, useful for corpora with large
        number of documents.
    ...
    def _concat(self, batch_num):
        """Concatenates current preprocessed batch to CSV containing output of
        previous batches.
    ...
    def preprocess(self, src_output_path, tgt_output_path, batch_size, funcs='all'):
        ...
        :param batch_size: Number of documents to be brought into memory at a
            time.
        :type batch_size: int
        :param funcs: Preprocessing functions to apply to raw corpus (refer
            globals.py for allowed functions).
        :type funcs: str, list
        """
